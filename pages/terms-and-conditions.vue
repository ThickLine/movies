    ...
    <div>
        <div p="y15 x15"
            ...
            <h2 text-2xl
                md:text-3xl
                font-bold
                my-4>Terms and Conditions</h2>
            <p class="my-2">Welcome to Movie Up Next!</p>
            <p class="my-2">These terms and conditions outline the rules and regulations for the use of MUN's Website,
                located
                at https://movieupnext.com/.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Movie Up
                Next
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                ...
                Company's stated services, in accordance with and subject to, prevailing law of lv. Any use of the above
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>Cookies</strong></h3>

            <p>We employ the use of cookies. By accessing Movie Up Next, you agreed to use cookies in agreement with the
                MUN's
                Privacy Policy. </p>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>License</strong></h3>

            <p>Unless otherwise stated, MUN and/or its licensors own the intellectual property rights for all material on
                Movie
                Up Next. All intellectual property rights are reserved. You may access this from Movie Up Next for your own
                personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Movie Up Next</li>
                <li>Sell, rent or sub-license material from Movie Up Next</li>
                <li>Reproduce, duplicate or copy material from Movie Up Next</li>
                <li>Redistribute content from Movie Up Next</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                areas of the website. MUN does not filter, edit, publish or review Comments prior to their presence on the
                website. Comments do not reflect the views and opinions of MUN,its agents and/or affiliates. Comments
                reflect
                the views and opinions of the person who post their views and opinions. To the extent permitted by
                applicable
                laws, MUN shall not be liable for the Comments or for any liability, damages or expenses caused and/or
                suffered
                as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

            <p>MUN reserves the right to monitor all Comments and to remove any Comments which can be considered
                inappropriate,
            ...
            <p>You hereby grant MUN a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
                and
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>Hyperlinking to our Content</strong></h3>
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                ...
                records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of MUN;
                and
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
                you
                must inform us by sending an e-mail to MUN. Please include your name, your organization name, contact
            ...
            <p>No use of MUN's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>

            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>iFrames</strong></h3>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>Content Liability</strong></h3>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>Reservation of Rights</strong></h3>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>Removal of links from our website</strong></h3>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4><strong>Disclaimer</strong></h3>
