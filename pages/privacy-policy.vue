    ...
    <div>
        <div p="y15 x15"
            ...
            <h2 text-2xl
                md:text-3xl
                font-bold
                my-4>Privacy Policy for MUN</h2>

            <p>At Movie Up Next, accessible from https://movieupnext.com, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by Movie
                Up
                Next and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards
                to the information that they shared and/or collect in Movie Up Next. This policy is not applicable to any
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Information we collect</h3>
            ...
            <p>If you <a href="mailto:support@movieupnext.com">contact us</a> directly, we may receive additional
                information
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>How we use your information</h3>
            ...
            <p>Movie Up Next follows a standard procedure of using log files. These files log visitors when they visit
                websites.
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Cookies and Web Beacons</h3>

            <p>Like any other website, Movie Up Next uses "cookies". These cookies are used to store information including
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Google DoubleClick DART Cookie</h3>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Advertising Partners Privacy Policies</h3>

            <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Movie Up Next.
            </p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in
                their respective advertisements and links that appear on Movie Up Next, which are sent directly to users'
            ...
            <p>Note that Movie Up Next has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Third Party Privacy Policies</h3>

            <p>Movie Up Next's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>CCPA Privacy Rights (Do Not Sell My Personal Information)</h3>
            ...
            <p>If you make a request, we have one month to respond to you. If you would like to exercise any of these
                rights,
                please <a href="mailto:support@movieupnext.com">contact us</a>.</p>

            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>GDPR Data Protection Rights</h3>
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Children's Information</h3>
            ...
            <p>Movie Up Next does not knowingly collect any Personal Identifiable Information from children under the age of
                13.
                If you think that your child provided this kind of information on our website, we strongly encourage you to
                <a href="mailto:support@movieupnext.com">contact us</a> immediately and we will do our best efforts to
                promptly
            ...
            <h3 text-xl
                md:text-2xl
                font-bold
                my-4>Changes to This Privacy Policy</h3>
            ...
            <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to <a
                   href="mailto:support@movieupnext.com">contact us</a>.</p>
