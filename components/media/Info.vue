...
<template>
            <div p4
              ...
              <NuxtImg width="400"
                       height="600"
                       format="webp"
                       :src="`${TMDB_IMAGE_BASE_THUMBNAIL}/${props.item.poster_path}`"
              ...
              <div lt-md:w="[calc(100vw-2rem)]"
                ...
                <div v-if="props.item.overview">
                  ...
                  <div op80
                       v-text="props.item.overview" />
                </div>

                <div text-sm
                     op80>
                  <ul grid="~ cols-[max-content_1fr] lg:cols-[max-content_1fr_max-content_1fr] gap3"
                      items-center>
                    ...
                    <template v-if="directors?.length">
                      ...
                      <div flex="~ row wrap gap1">
                        <NuxtLink v-for="person of directors"
                                  :key="person.id"
                                  :to="`/person/${person.id}`"
                    ...
                    <template v-if="props.item.genres && props.item.genres.length">
                      ...
                      <div flex="~ row wrap gap1">
                        <NuxtLink v-for="genre of props.item.genres"
                                  :key="genre.id"
                ...
                <div>
                  <ExternalLinks :links="externalIds" :routeName="type"/>
      </div>
    </div>
  </div>
</template>
